...
<%
				...
				if(obj2!=null && obj3!=null){
					...
					if(sem.equals("3"))%>
				<jsp:forward page="index_landing3.jsp"></jsp:forward>
				<%if(sem.equals("4")) %>
				<jsp:forward page="index_landing4.jsp"></jsp:forward>
				<%if(sem.equals("5")) %>
				<jsp:forward page="index_landing5.jsp"></jsp:forward>
				<%if(sem.equals("6")) %>
				<jsp:forward page="index_landing6.jsp"></jsp:forward>
				<%if(sem.equals("7")) %>
				<jsp:forward page="index_landing7.jsp"></jsp:forward>
				<%if(sem.equals("8")) %>
				<jsp:forward page="index_landing8.jsp"></jsp:forward>
				<%}%>
