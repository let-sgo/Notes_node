...
/**
 * Servlet implementation class AddRollNoSliderController
 */
@WebServlet("/AddRollNoSliderController")
public class AddRollNoSliderController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddRollNoSliderController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean result=rld.enterRollNoSlider(startRollNo1, total_student1, year1);
		if(result){
