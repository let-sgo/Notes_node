...
<head>
 ...
 <body>
                    ...
                    <div class="row">
                        ...
                        <div class="eight wide column">
                                            ...
                                            <!-- <button class="ui red right floated button" id="myButton">
												...
												<form action="update_year" method="post">
                                            <select name="year1" class="custom-select custom-select-lg mb-3" style="margin-top:30px;">
                                              ...
                                              <select name="year2" class="custom-select custom-select-lg mb-3" style="margin-top:30px;">
    ...
    <div class="ui inverted vertical footer segment" style="margin-top :100px;">
